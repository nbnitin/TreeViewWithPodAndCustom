...
//    init(name : String, children: [DataObject], id : String, parentId : String) {
//        self.name = name
...
//    }
//
//    convenience init(name : String, id : String, parentId : String) {
//        self.init(name: name,children: [DataObject](), id:id,parentId:id)
//    }
